          ...
          >
            ...
            <div className="overflow-hidden">
              <Image
                ...
                height={250}
                alt={e.title}
                className="w-100 h-72 group-hover:scale-105 transition duration-300"
              />
            </div>
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: Math.floor(e.ratingsAverage) }).map((_, i) => (
                  <Star key={i} className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                ))}

                {Array.from({ length: 5 - Math.floor(e.ratingsAverage) }).map((_, i) => (
